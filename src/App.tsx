...
function App() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    try {
      if (authMode === 'signup') {
        ...
        // Set the current page to home after successful signup
        setCurrentPage('home');
      } else {
  ...
  // Set initial page to home when user logs in
  useEffect(() => {
    if (user) {
      setCurrentPage('home');
    }
    ...
    return (
      <div className="auth-container">
        <div className="auth-card">
          ...
          <button onClick={() => alert('GitHub OAuth coming soon!')} className="github-auth">
